...
export default function AdminPage() {
  ...
  const menuItems = getMenuItems('iam')
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading IAM panel...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">You don't have permission to access the IAM panel.</p>
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="border-b border-gray-200 bg-white px-6 py-4">
          <h1 className="text-3xl font-bold text-black">Identity Access Manager (IAM)</h1>
        ...
        <div className="flex items-center space-x-4">
          ...
          {!canManageRoles && (
            <div className="text-sm text-gray-500 bg-gray-50 px-3 py-2 rounded-md">
              ...
              View-only access - Contact IAM admin to manage roles
            </div>
          )}
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          {!canManageUsers && (
            <div className="text-sm text-gray-500 bg-gray-50 px-3 py-2 rounded-md">
              ...
              View-only access - Contact IAM admin to manage users
            </div>
          )}
          <div className="relative">
